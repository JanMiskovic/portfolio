...
export default function Socials() {
    return (
        <div
            className="flex h-9 flex-wrap items-center gap-1.5 overflow-hidden xs:h-10 sm:gap-2.5
                sm:overflow-visible">
            <Button3D
                ...
                innerClassName="bg-[hsl(273,_100%,_96%)] hover:bg-[hsl(273,_100%,_94%)]
                    ...
                    dark:active:bg-bg-dark">
                <BsGithub
                    className="transition-hover h-4 w-4 fill-icon-light xs:h-5 xs:w-5 sm:h-6 sm:w-6
                        dark:fill-[hsl(273,_100%,_70%)] dark:group-hover:fill-[hsl(273,_100%,_73%)]
            ...
            <Button3D
                ...
                innerClassName="bg-[hsl(192,_100%,_96%)] hover:bg-[hsl(192,_100%,_94%)]
                    active:bg-[hsl(192,_100%,_93%)] dark:bg-bg-dark dark:hover:bg-bg-dark
                    dark:active:bg-bg-dark">
                <BsLinkedin
                    className="transition-hover h-4 w-4 rounded-full fill-icon-light xs:h-5 xs:w-5 sm:h-6
                        sm:w-6 dark:fill-[hsl(192,_100%,_70%)]
            ...
            <Button3D
                ...
                innerClassName="bg-[hsl(229,_100%,_96%)] hover:bg-[hsl(229,_100%,_94%)]
                    active:bg-[hsl(229,_100%,_93%)] dark:bg-bg-dark dark:hover:bg-bg-dark
                    dark:active:bg-bg-dark">
                <BsFacebook
                    className="transition-hover h-4 w-4 fill-icon-light xs:h-5 xs:w-5 sm:h-6 sm:w-6
                        dark:fill-[hsl(229,_100%,_70%)] dark:group-hover:fill-[hsl(229,_100%,_73%)]
            ...
            <Button3D
                ...
                innerClassName="bg-[hsl(309,_100%,_96%)] hover:bg-[hsl(309,_100%,_94%)]
                    active:bg-[hsl(309,_100%,_93%)] dark:bg-bg-dark dark:hover:bg-bg-dark
                    dark:active:bg-bg-dark">
                {/* Instagram icon */}
                <svg
                    viewBox="0 0 16 16"
                    ...
                    className="transition-hover h-4 w-4 rounded-full fill-icon-light xs:h-5 xs:w-5 sm:h-6
                        sm:w-6 dark:fill-[hsl(309,_100%,_70%)]
            ...
            <Button3D
                ...
                innerClassName="bg-[hsl(127,_100%,_96%)] hover:bg-[hsl(127,_100%,_94%)]
                    active:bg-[hsl(127,_100%,_93%)] dark:bg-bg-dark dark:hover:bg-bg-dark
                    dark:active:bg-bg-dark">
                <BsSpotify
                    className="transition-hover h-4 w-4 fill-icon-light xs:h-5 xs:w-5 sm:h-6 sm:w-6
                        dark:fill-[hsl(127,_100%,_70%)] dark:group-hover:fill-[hsl(127,_100%,_73%)]
