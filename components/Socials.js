    ...
    return (
        <div className="flex items-center gap-1.5 sm:gap-2.5 flex-wrap h-9 xs:h-10 sm:h-11 overflow-hidden">
            <a href="https://github.com/JanMiskovic" target="_blank" rel="noreferrer"
                ...
                <BsGithub className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 transition-hover
            ...
            <a href="" target="_blank" rel="noreferrer"
                ...
                <BsLinkedin className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 transition-hover rounded-full
            ...
            <a href="https://www.facebook.com/mutualslump/" target="_blank" rel="noreferrer"
                ...
                <BsFacebook className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 transition-hover
            ...
            <a href="https://open.spotify.com/user/kthen1337" target="_blank" rel="noreferrer"
                ...
                <BsSpotify className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 transition-hover
