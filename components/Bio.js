...
export default function Bio() {
    return (
        <div className="grid grid-cols-[auto_minmax(0,_1fr)] md:grid-cols-3 items-center
            ...
            <Image src="/profile_pic.jpg" width={300} height={300} alt="Profile picture of Ján" 
            ...
            <div className="col-start-2 col-span-full md:self-end">
                ...
                <Image priority={true} src="/icons/skflag.webp" width={20} height={20} alt="Flag of the Slovak Republic"
